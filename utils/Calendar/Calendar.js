...
let Calendar = function() {
     ...
     * @var array
     */
    this.colors = ['青', '青', '红', '红', '黄', '黄', '白', '白', '黑', '黑'];
     ...
     * @var array
     */
    this.weekdayAlias = ['日', '一', '二', '三', '四', '五', '六', '七', '八', '九', '十'];
     ...
     * @var array
     */
    this.monthAlias = ['正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '冬', '腊'];
}
/**
 * 传入阳历年月日获得详细的公历、农历信息.
 *
 ...
 * @return array
 */
Calendar.prototype.lunar = function(year, month, day, isLeapMonth = false, hour = null) {
 ...
 * @return int
 */
Calendar.prototype.monthsOfYear = function(year) {
 ...
 * @return int
 */
Calendar.prototype.leapMonth = function(year) {
    // 闰字编码 \u95f0
 ...
 * @return int
 */
Calendar.prototype.leapDays = function(year) {
 ...
 * @return int
 */
Calendar.prototype.lunarDays = function(year, month) {
 ...
 * @return int
 */
Calendar.prototype.solarDays = function(year, month) {
    // 若参数错误 返回-1
    if (month > 12 || month < 1) {
        return -1;
    }
 ...
 * @return string
 */
Calendar.prototype.ganZhiYear = function(lunarYear, termIndex = null) {
    /**
 ...
 * @return int
 */
Calendar.prototype.getTerm = function(year, no) {
 ...
 * @return string
 */
Calendar.prototype.toChinaMonth = function(month) {
    // 若参数错误 返回 -1
    if (month > 12 || month < 1) {
 ...
 * @return string
 */
Calendar.prototype.toChinaDay = function(day) {
    switch (day) {
        case 10:
            return '初十';
        case 20:
 ...
 * @return string
 */
Calendar.prototype.getColor = function(ganZhi) {
    if (!ganZhi) {
        return null;
    }
 ...
 * @return array
 */
Calendar.prototype.solar2lunar = function(year, month, day, hour = null) {
    if (23 == hour) {
 ...
 * @return array|int
 */
Calendar.prototype.lunar2solar = function(year, month, day, isLeapMonth = false) {
    ...
    let solarYear, solarMonth, solarDay = explode('-', date);
 ...
 * @return int
 */
Calendar.prototype.diffInYears = function(lunar1, lunar2, absolute = true) {
 ...
 * @return int
 */
Calendar.prototype.diffInMonths = function(lunar1, lunar2, absolute = true) {
    solar1 = this.lunar2solar(lunar1['lunar_year'], lunar1['lunar_month'], lunar1['lunar_day'], lunar1['is_leap']);
    date1 = this.makeDate("{solar1['solar_year']}-{solar1['solar_month']}-{solar1['solar_day']}");
 ...
 * @return int
 */
Calendar.prototype.diffInDays = function(lunar1, lunar2, absolute = true) {
    solar1 = this.lunar2solar(lunar1['lunar_year'], lunar1['lunar_month'], lunar1['lunar_day'], lunar1['is_leap']);
    date1 = this.makeDate("{solar1['solar_year']}-{solar1['solar_month']}-{solar1['solar_day']}");
 ...
 * @return array
 */
Calendar.prototype.addYears = function(lunar, value = 1, overFlow = true) {
 ...
 * @return array
 */
Calendar.prototype.subYears = function(lunar, value = 1, overFlow = true) {
 ...
 * @return array
 */
Calendar.prototype.addMonths = function(lunar, value = 1, overFlow = true) {
    if (0 > value) {
 ...
 * @return array
 */
Calendar.prototype.subMonths = function(lunar, value = 1, overFlow = true) {
    if (0 > value) {
 ...
 * @return array
 */
Calendar.prototype.addDays = function(lunar, value = 1) {
 ...
 * @return array
 */
Calendar.prototype.subDays = function(lunar, value = 1) {
